...
- Conditional probability: Likelihood that an outcome randomly sampled from the subset with 𝐵 has 𝐴 (i.e., conditional is opposed to marginal)
...
<center>
<iframe width="560" height="700" src="https://www.youtube.com/embed/AD6eJlbFa2I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
---
# Monty Hall
...
- Suppose there is a disease outbreak in an enclosed population. It is turning folks into zombies. Your friend tested positive. How likely is it they are a zombie?
...
- Based on the results of this test, the probability that your friend actually is a zombie is .54   
  ...
  - That's a 54% chance of being zombie
    ...
    - Sorry. Your friend might be a zombie
...
.pull-left[
    - Probabilities associated with random variables

    - Describes the shape in terms of likelihood or probability
 
    - If shaped like a normal distribution (most common), we can use the PDF to find out probability of scores
...
knitr::include_graphics("images/Normal_Distribution_CDF.svg")
```
---
# R
