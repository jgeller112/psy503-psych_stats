...
- A function that characterizes any continuous probability distribution

.pull-left[
    - Probabilities associated with random variables

    - Describes the shape in terms of probability
    
    - The integral of the probability density function in the interval [a,b] yields the probability that a given random variable with the given density is contained in the interval provided
