...
- See where the statistic lies relative to ‘critical score’ that depends on defined alpha (same procedure  used to calculate confidence intervals)
...
- Research Hypothesis: I hypothesize that fluent lecturers help increase learning
...
2. Decide on test statistic and critical value

3. Calculate the corresponding test statistic and compare the result against the “critical value”
...
- Step 2 
    ...
    - Define your level of significance (α)
      ...
      - Some use others (call for p <.005)
