...
subtitle: "Modeling Continuous Relationships"
...
$$Y_i = b_0(\alpha) + b_1X_i + \varepsilon_i$$
---
# Describing a Straight Line
...
- We use a method known as least squares to obtain estimates of 𝛼 and 𝛽
...
- How to analyze your regression analysis
...
```
---
# Getting Residuals and Model Fit
```{r}
...
- $R^2$ of `r round(rq2, 3)` means `r round(rq2,3)`% of variance is explained 

---
# Reporting

- `r report_model(model1)`
---
# Your turn
...
$\hat{Ŷ}$ = predicted value on the outcome variable Y
...
3. Homogeneity of residual variance (“homoskedasticity”)
...
- Collinearity = two predictors A and B are collinear if there is a linear combination of A and B that equals zero for all data
...
- If your assumptions go wrong:
    ...
    - Multicolineary - drop one of the predictors; ridge regression; Lasso
---
# Regression Model
