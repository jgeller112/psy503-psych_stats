...
-  General mathematical framework
    ...
    - Essentially linear regression all the way down 
    - Highly flexible
      - Can fit qualtitive (categorical) and quanittive predictors
    - Easy to interpret
    - Helps understand interrealtdenss to other models
...
- Most of the statitical models we will fit depend on this assumption
...
```{r echo=FALSE,out.height="10%", out.width="50%",fig.cap="",fig.show='hold',fig.align='center'}
...
```{r echo=FALSE,out.height="5%", out.width="100%",fig.cap="",fig.show='hold',fig.align='center'}
...
- Converts a distribution with any $\mu$ and $\sigma$ to a $\mu$ = 0 and $\sigma$ = 1. 
---
# Conversions
...
```{r echo=FALSE,out.height="50%", out.width="80%",fig.cap="",fig.show='hold',fig.align='center'}
...
- dnorm(): zscore to density (height)
...
- Percentage Below a IQ score of 55?
...
- Percentage above a IQ score of 55?
...
Suppose that you have a normal random variable X with mean μ=70 and standard deviation σ=3, and you would like to find the chance that X will turn out to be less than 66. In other words, you are looking for:
...
# PnormGC
 ...
 - The probability that X is between 68 and 72, i.e.: $P(68<X<72)$
