...
knitr::include_graphics('properties_of_nd.png')
...
- Having characterized a distribution in terms of its central tendency and variability, it is often useful to express the individual scores in terms of where they sit with respect to the overall distribution.


$Z(x) = \frac{x - \mu}{\sigma}$

- Z-score tells us how far away any data point is from the mean, in units of standard deviation.
